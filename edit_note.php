                    ...
                    <div class="wrapper">
                      ...
                      <form method="POST">
                        ...
                        <div class="form-group">
                          ...
                          <input name="title" type="text" placeholder="Tuliskan Judul Catatan" class="input-sm form-control" value="<?php echo $row['title']; ?>">
                        </div>
                        <div class="form-group">
                          <label>Catatan</label>
                          <textarea name="note" class="form-control" rows="8" data-minwords="8" data-required="true" placeholder="Tulis Catatan Yang Ingin Dicatat"><?php echo $row['note']; ?></textarea>
                        </div>
                        <div class="m-t-lg"><button class="btn btn-sm btn-default" name="update" type="submit">Unggah Catatan</button></div>
                      </form>
                    </div>
                </aside>
