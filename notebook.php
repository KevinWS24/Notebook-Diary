  ...
  <section class="vbox">
    <header class="bg-dark dk header navbar navbar-fixed-top-xs">
      <div class="navbar-header aside-md">
        ...
        <a href="#" class="navbar-brand" data-toggle="fullscreen"><img src="images/Logodiary.jpg" class="m-r-sm">Notebook Diary</a>
      ...
      <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu animated fadeInRight">
            ...
            <li class="divider"></li>
            <li>
              <a href="logout.php" data-toggle="ajaxModal" >Keluar</a>
            </li>
          </ul>
        </li>
      </ul>      
        ...
        <section id="content">
          <section class="hbox stretch">
                  <aside class="aside-lg bg-light lter b-r">
                    <div class="wrapper">
                      <h4 class="m-t-none">Catatan Baru</h4>
                      <form method="POST">
                        ...
                        <div class="m-t-lg"><button class="btn btn-sm btn-default" name="submit" type="submit">Unggah Catatan</button></div>
                      </form>
                    </div>
                </aside>
                  ...
                  <section class="vbox">
                    <header class="header bg-light bg-gradient">
                      <ul class="nav nav-tabs nav-white">
                        <li class="active"><a href="#activity" data-toggle="tab"><h4 style = "text-transform:uppercase;"><b>Detail Catatan</b></h4></a></li>
                      </ul>
                    </header>
                          ...
                          <ul class="list-group no-radius m-b-none m-t-n-xxs list-group-lg no-border">
                            ...
                            <li class="list-group-item">
                                <div class="btn-group pull-right">
                                    <a href="edit_note.php?edit=<?php echo $note['note_id'];?>"><button type="button" class="btn btn-sm btn-default" title="Tampilkan Catatan"><i class="fa fa-eye"></i></button></a>
                                    <a href="notebook.php?delete=<?php echo $note['note_id'];?>"><button type="button" class="btn btn-sm btn-default" title="Hapus Catatan"><i class="fa fa-trash-o bg-danger"></i></button></a>
                                  </div>
